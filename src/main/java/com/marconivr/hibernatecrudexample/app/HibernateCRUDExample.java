...
public class HibernateCRUDExample {
    public static void main(String[] args) {
        ...
        Studente studente1 = new Studente("Mario", "Rossi", "5BI", 18);
        Studente studente2 = new Studente("Luigi", "Neri", "5BI", 18);
        System.out.println("- Crea due voti -");
        Voto voto1 = new Voto(3, new Date(System.currentTimeMillis() - 1000*60*60*24*2), studente1);
        Voto voto2 = new Voto(4, new Date(System.currentTimeMillis() - 1000*60*60*24), studente1);
